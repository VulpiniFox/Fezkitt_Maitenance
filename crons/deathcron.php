...
// ALERT THE MEMBER
		...
		$deleterip = mysql_query("UPDATE ferrets SET owner = -1 AND SET incage = 0 AND SET stud = 0 AND SET publicsale = 0 WHERE id = " . $deathb['id'] . " LIMIT 1");
...
// ALERT THE MEMBER
		...
		$deleterip = mysql_query("UPDATE ferrets SET owner = -1 AND SET incage = 0 AND SET stud = 0 AND SET publicsale = 0 WHERE id = " . $deathc['id'] . " LIMIT 1");
...
// ALERT THE MEMBER
		...
		$deleterip = mysql_query("UPDATE ferrets SET owner = -1 AND SET incage = 0 AND SET stud = 0 AND SET publicsale = 0 WHERE id = " . $deathd['id'] . " LIMIT 1");
...
// ALERT THE MEMBER
		...
		$deleterip = mysql_query("UPDATE ferrets SET owner = -1 AND SET incage = 0 AND SET stud = 0 AND SET publicsale = 0 WHERE id = " . $deathe['id'] . " LIMIT 1");
...
// ALERT THE MEMBER
		...
		$deleterip = mysql_query("UPDATE ferrets SET owner = -1 AND SET incage = 0 AND SET stud = 0 AND SET publicsale = 0 WHERE id = " . $deathf['id'] . " LIMIT 1");
...
// ALERT THE MEMBER
		...
		$deleterip = mysql_query("UPDATE ferrets SET owner = -1 AND SET incage = 0 AND SET stud = 0 AND SET publicsale = 0 WHERE id = " . $deathg['id'] . " LIMIT 1");
